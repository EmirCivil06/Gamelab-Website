...
export default function Projects() {
  ...
  return (
    <>
      <div className="tri-gradient projects-bg flex-row! items-center gap-5 pb-20! pt-18! px-0! page-default">
        <div className="w-full items-center py-[clamp(3.5rem,7vw,8rem)] xl:gap-0 gap-7.5 xl:py-[clamp(1.5rem,3.5vw,4rem)] flex flex-col projects-dashboard-gradient gradient-base justify-center">
          <div className="dashboard-paragraph">
            ...
            <p className="paragraph text-[#5D4037] bg-[rgb(215,203,165)]!">
              Gamelab topluluğu olarak farklı projeler üzerinde çalıştık ve
              çalışmaya da devam ediyoruz. Şuana kadar yapmış olduğumuz farklı
              projelere aşağıdan ulaşabilirsiniz.
            </p>
          </div>
